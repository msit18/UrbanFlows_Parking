...
imagePath = '/home/ubuntu/Parking/{0}/{1}/*.jpg'.format(siteFolder, folderName)
...
# rotationVar = -2.5
# ftperpx = 81/850 # (4parkingx20ft+3linesx1/3ft)/(1353-503)
# estftperpx = 81/1126 # (4parkingx20ft+3linesx1/3ft)/(1629-503)
